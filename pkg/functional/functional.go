...
// MapMaps modifies each pair of a map[k]v using the provided function, and returns the modified slice
// (note to self: update gist if any changes to this func https://gist.github.com/finicu212/8b95436426b3336981a9d82d0cab2d94)
func MapMaps[M interface{ ~map[Key]Value }, Key comparable, Value any, ReturnType any](s M, f func(Key, Value) ReturnType) []ReturnType {
